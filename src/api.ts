import { getTwoEmbed } from "./workers/sites/2Embed";
import { getAutoembed } from "./workers/sites/AutoEmbed";
import { getEmbedSu } from "./workers/sites/Embedsu";
import { getVidSrcSu } from "./workers/sites/VidsrcSU";

export async function getMovie(media: any, provider?: null | string) {
...
export async function getTv(media: any, season: string, episode: string, provider?: null | string) {
    const combinedResponse = [];
    const tmdb_id = media.tmdbId;
